## Overview
RPG Maker MV / MZ addon to translate all text that gets drawn on the screen. Supported translators: DeepL (bring your own key), local LLM, and cache-only `none` mode backed by `translation-cache.log`.
