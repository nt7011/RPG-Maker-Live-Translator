...
function normalizeDiagnosticProvider(provider) {
    ...
    return {
        ...
        apiResponding: source.apiResponding === true,
        modelCatalogAt: source.modelCatalogAt || null,
        modelCatalogError: source.modelCatalogError ? String(source.modelCatalogError) : '',
        modelCount: normalizeInteger(source.modelCount),
        loadedLlmInstanceCount: normalizeInteger(source.loadedLlmInstanceCount),
        modelSelectionReady: source.modelSelectionReady === true,
        modelSelectionError: source.modelSelectionError ? String(source.modelSelectionError) : '',
        statusUpdatedAt: source.statusUpdatedAt || null,
        modelKey: source.modelKey ? String(source.modelKey) : '',
        modelInstanceId: source.modelInstanceId ? String(source.modelInstanceId) : '',
        modelAuthor: source.modelAuthor ? String(source.modelAuthor) : '',
        modelName: source.modelName ? String(source.modelName) : '',
        quantization: source.quantization ? String(source.quantization) : '',
        selectedVariant: source.selectedVariant ? String(source.selectedVariant) : '',
