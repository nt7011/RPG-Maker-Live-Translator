...
(() => {
    ...
    if (typeof defineRuntimeModule !== 'function') {
        throw new Error('[LiveTranslator] runtime module registry is unavailable before runtime/replay-filter.js.');
    }
    if (typeof requireRuntimeModule !== 'function') {
        throw new Error('[LiveTranslator] runtime module require is unavailable before runtime/replay-filter.js.');
    }
    ...
    if (!entryLifecycle || typeof entryLifecycle.isStale !== 'function') {
        throw new Error('[LiveTranslator] runtime.entryLifecycle is unavailable before runtime/replay-filter.js.');
    }
    ...
    defineRuntimeModule('runtime.replayFilter', { create: createReplayFilter });
})();
