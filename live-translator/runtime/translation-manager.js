...
(() => {
    ...
    LiveTranslatorDefine({
        name: 'runtime.translationManager',
        requires: {
            constants: 'runtime.translationManager.constants',
            common: 'runtime.translationManager.common',
            cache: 'runtime.translationManager.cache',
            handles: 'runtime.translationManager.handles',
            controllerFacadesModule: 'runtime.translationManager.controllerFacades',
            schedulerPolicyModule: 'runtime.translationManager.schedulerPolicy',
            eligibilityController: 'runtime.translationManager.eligibility',
            jobsController: 'runtime.translationManager.jobs',
            subscribersController: 'runtime.translationManager.subscribers',
            requestsController: 'runtime.translationManager.requests',
            queueController: 'runtime.translationManager.queue',
            runnerController: 'runtime.translationManager.runner',
            apiController: 'runtime.translationManager.api',
        },
        factory({ constants, common, cache, handles, controllerFacadesModule, schedulerPolicyModule, eligibilityController, jobsController, subscribersController, requestsController, queueController, runnerController, apiController }, { scope: globalScope }) {
            const controllers = {
            ...
            function createTranslationService(options = {}) {
                ...
                scope.translationIntel = shared.resolveTranslationIntelFactory()({
                    globalScope,
                    provider,
                    isCacheOnlyProvider,
                    settings,
                ...
                scope.translationIntel.publish();
                ...
                function startProviderAvailabilityProbe(reason = '') {
                    ...
                    if (probe.startedAt === null || probe.startedAt === undefined) {
                        ...
                        probe.attempts = 0;
                        scope.translationIntel.recordLazy('provider.availability_probe.started', () => ({
                            reason: String(reason || ''),
                        }));
                    }
                ...
                function emitProviderAvailabilityEvent(type, evaluation) {
                    ...
                    if (scope.translationIntel && typeof scope.translationIntel.recordLazy === 'function') {
                        scope.translationIntel.recordLazy(type, () => event);
                    }
