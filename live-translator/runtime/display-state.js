...
(() => {
    ...
    if (typeof defineRuntimeModule !== 'function') {
        throw new Error('[LiveTranslator] runtime module registry is unavailable before runtime/display-state.js.');
    }

    function createDisplayStateService(scope = globalScope) {
        const runtimeGlobal = scope || globalScope;
    ...
    defineRuntimeModule('runtime.displayState', {
