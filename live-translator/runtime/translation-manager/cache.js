    ...
    LiveTranslatorDefine({
        ...
        factory({ common, constants, textCodec }, { scope }) {
            ...
            function getLoadedPrecacheRecords() {
                try {
                    const assets = scope && scope.LiveTranslatorAssets;
                    ...
                    if (Array.isArray(scope.LiveTranslatorPrecache)) return scope.LiveTranslatorPrecache;
                } catch (_) {}
                return [];
            }
