...
(() => {
    ...
    LiveTranslatorDefine({
        name: 'adapters.pixiText',
        requires: {
            pixiUtils: 'adapters.pixiText.utils',
            pixiAdapterHelpers: 'adapters.pixiText.adapterHelpers',
            pixiTextScale: 'adapters.pixiText.textScale',
            pixiRenderController: 'adapters.pixiText.renderController',
            pixiLifecycleController: 'adapters.pixiText.lifecycleController',
            pixiStateController: 'adapters.pixiText.stateController',
            pixiVisibilityController: 'adapters.pixiText.visibilityController',
        },
        factory({
            pixiUtils,
            pixiAdapterHelpers,
            pixiTextScale,
            pixiRenderController,
            pixiLifecycleController,
            pixiStateController,
            pixiVisibilityController,
        }, { scope }) {
