...
(() => {
    ...
    LiveTranslatorDefine({
        name: 'adapters.gameMessage',
        requires: {
            controllerFacades: 'adapters.gameMessage.controllerFacades',
            install: 'adapters.gameMessage.install',
            evaluation: 'adapters.gameMessage.evaluation',
            text: 'adapters.gameMessage.text',
            wrapping: 'adapters.gameMessage.wrapping',
            redraw: 'adapters.gameMessage.redraw',
            session: 'adapters.gameMessage.session',
            detection: 'adapters.gameMessage.detection',
            foresightContext: 'adapters.gameMessage.foresightContext',
            foresightHooks: 'adapters.gameMessage.foresightHooks',
            foresightRecords: 'adapters.gameMessage.foresightRecords',
            clear: 'adapters.gameMessage.clear',
            records: 'adapters.gameMessage.records',
            render: 'adapters.gameMessage.render',
        },
        factory({
            controllerFacades,
            install,
