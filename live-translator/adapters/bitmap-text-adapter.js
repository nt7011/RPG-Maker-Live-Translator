...
(() => {
    ...
    function createBitmapTextAdapter(context = {}) {
        ...
        const methodControllers = {
            ...
            prepareCopiedBitmapTargetsForMutation: 'replay',
            commitCopiedBitmapTargetsForMutation: 'replay',
            invalidateCopiedBitmapTargetsForMutation: 'replay',
            hasCopiedBitmapTargetsForBitmap: 'replay',
            redrawCopiedBitmapTargets: 'replay',
            forgetCopiedBitmapTargets: 'replay',
            markBitmapPixelsDirty: 'replay',
