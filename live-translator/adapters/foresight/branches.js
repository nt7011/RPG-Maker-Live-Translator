...
(() => {
    ...
    LiveTranslatorRun({
        name: 'adapters.foresight.branches',
        requires: {
        ...
        run({ partsRegistry }) {
            ...
            const { resolveControlFlowTarget } = parts.facades.movementFlow;
            const { createBranchBudgetSnapshot } = parts.facades.budget;
            const { nonEmptyString } = parts.facades.utils;
