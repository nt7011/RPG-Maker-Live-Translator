...
(() => {
    ...
    LiveTranslatorRun({
        name: 'adapters.foresight.nestedLists',
        requires: {
        ...
        run({ partsRegistry }, { scope: globalScope }) {
            ...
            const { createConsumedEventCommands } = parts.facades.intel;
            const { positiveInteger, nullableFiniteNumber, nonEmptyString } = parts.facades.utils;
